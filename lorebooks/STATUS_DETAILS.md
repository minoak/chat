...
- 💪 STR (Strength): {{getvar::player_str}} / 100
- 🧠 INT (Intelligence): {{getvar::player_int}} / 100
- 🤸 DEX (Dexterity): {{getvar::player_dex}} / 100
- 💬 CHA (Charisma): {{getvar::player_cha}} / 100
- 🍀 LUK (Luck): {{getvar::player_luk}} / 100
- ❤️ VIT (Vitality): {{getvar::player_vit}} / 100
...
{{#if {{and::{{? {{getvar::player_str}} >= 81}}::{{? {{getvar::player_str}} <= 90}}}}}}
...
{{#if {{and::{{? {{getvar::player_str}} >= 71}}::{{? {{getvar::player_str}} <= 80}}}}}}
...
{{#if {{and::{{? {{getvar::player_str}} >= 61}}::{{? {{getvar::player_str}} <= 70}}}}}}
...
{{#if {{and::{{? {{getvar::player_str}} >= 51}}::{{? {{getvar::player_str}} <= 60}}}}}}
...
{{#if {{and::{{? {{getvar::player_int}} >= 81}}::{{? {{getvar::player_int}} <= 90}}}}}}
...
{{#if {{and::{{? {{getvar::player_int}} >= 71}}::{{? {{getvar::player_int}} <= 80}}}}}}
...
{{#if {{and::{{? {{getvar::player_int}} >= 61}}::{{? {{getvar::player_int}} <= 70}}}}}}
...
{{#if {{and::{{? {{getvar::player_int}} >= 51}}::{{? {{getvar::player_int}} <= 60}}}}}}
...
{{#if {{and::{{? {{getvar::player_dex}} >= 81}}::{{? {{getvar::player_dex}} <= 90}}}}}}
...
{{#if {{and::{{? {{getvar::player_dex}} >= 71}}::{{? {{getvar::player_dex}} <= 80}}}}}}
...
{{#if {{and::{{? {{getvar::player_dex}} >= 61}}::{{? {{getvar::player_dex}} <= 70}}}}}}
...
{{#if {{and::{{? {{getvar::player_dex}} >= 51}}::{{? {{getvar::player_dex}} <= 60}}}}}}
...
{{#if {{and::{{? {{getvar::player_cha}} >= 81}}::{{? {{getvar::player_cha}} <= 90}}}}}}
...
{{#if {{and::{{? {{getvar::player_cha}} >= 71}}::{{? {{getvar::player_cha}} <= 80}}}}}}
...
{{#if {{and::{{? {{getvar::player_cha}} >= 61}}::{{? {{getvar::player_cha}} <= 70}}}}}}
...
{{#if {{and::{{? {{getvar::player_cha}} >= 51}}::{{? {{getvar::player_cha}} <= 60}}}}}}
...
{{#if {{and::{{? {{getvar::player_luk}} >= 81}}::{{? {{getvar::player_luk}} <= 90}}}}}}
...
{{#if {{and::{{? {{getvar::player_luk}} >= 71}}::{{? {{getvar::player_luk}} <= 80}}}}}}
...
{{#if {{and::{{? {{getvar::player_luk}} >= 61}}::{{? {{getvar::player_luk}} <= 70}}}}}}
...
{{#if {{and::{{? {{getvar::player_luk}} >= 51}}::{{? {{getvar::player_luk}} <= 60}}}}}}
...
{{#if {{and::{{? {{getvar::player_vit}} >= 81}}::{{? {{getvar::player_vit}} <= 90}}}}}}
...
{{#if {{and::{{? {{getvar::player_vit}} >= 71}}::{{? {{getvar::player_vit}} <= 80}}}}}}
...
{{#if {{and::{{? {{getvar::player_vit}} >= 61}}::{{? {{getvar::player_vit}} <= 70}}}}}}
...
{{#if {{and::{{? {{getvar::player_vit}} >= 51}}::{{? {{getvar::player_vit}} <= 60}}}}}}
