...
```
🎲 [STAT] Check: {1d20 result} + {bonus} = {total} (Target: {difficulty target})
→ Success/Failure
```
...
🎲 DEX 체크: 15 (d20) + 2 (DEX 보너스) = 17 (목표: 10 - Easy)
✅ 성공!
...
🎲 CHA 체크: 6 (d20) + 1 (CHA 보너스) = 7 (목표: 20 - Hard)
❌ 실패!
...
🎲 DEX 체크: 20 (d20) + 2 (DEX 보너스) = 22 (목표: 15 - Normal)
🌟 크리티컬 성공!
