...
| 레벨 | 지수 범위 | 상태 | 시장 분위기 |
|------|----------|------|------------|
| Crisis | < 850 | 폭락 | 공포, 투매, 파산 |
| Bear | 850~950 | 약세 | 불안, 매도 우위 |
| Stable | 950~1050 | 안정 | 평온, 관망세 |
| Bull | 1050~1150 | 강세 | 낙관, 매수 우위 |
| Boom | > 1150 | 호황 | 열광, 버블 주의 |
...
### 시장 태그
```
[Market:INDEX:CHANGE:NEWS]  - 지수 업데이트
```
예시: `[Market:1050:+2.5:황금갈기 금고 분기 실적 호조]`

### 시장 디스플레이
```
<MarketPanel />  - 시장 현황 패널 (최신 채팅에만 표시)
```

### 시장 뉴스 예시
- Bull: "GOLDMANE 주도 금융주 강세", "마도공학 붐 지속"
- Bear: "MUTAGEN 임상 실패 여파", "경기 침체 우려 확산"
- Crisis: "릴리벨리 대폭락! 투자자 아비규환"
