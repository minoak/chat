...
## 9. Capitalism 스타일 경영 시스템

### 컨셉
- 참고: Capitalism 게임 (경영 시뮬레이션)
- 단순 주식 매매 → **캐릭터 기업 경영 참여**
...
|------|------|
| player_gold | 보유 현금 |
| player_total_assets | 총 자산 |
| market_index | 시장 지수 |
| economic_cycle | 경기 상황 |

### 경영 의사결정 예시
```
미라벨: "GOLDMANE에서 신규 지점 확장 건이 올라왔어.
        500G 투자하면 시장 점유율 올라갈 거야. 어떻게 할래?"
...
[성공 시]
미라벨: "역시 너야! 점유율 5% 올랐어 ㅋㅋ"
→ market_share +5, price +10

[실패 시]
미라벨: "ㅋㅋㅋ 완전 망했어... 뭐 어쩔 수 없지"
→ cash -500, price -15
```
